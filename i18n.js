...
(() => {
    ...
    const DICT = {
        ...
        about_p1: {
            en: `My most popular and most loved project is <strong><a href="https://modrinth.com/mod/ardas-sculks" target="_blank" rel="noopener">Arda's Sculks</a></strong> — a deep dark expansion that adds new blocks, mechanics, and a full boss fight, playable on both 1.21.1 and 1.20.1. You can find it, along with all my other work, in the Projects tab, where each mod links directly to its Modrinth or CurseForge page.<br><br>In total, I've released 12 projects for Forge and NeoForge. Some are small, focused builds — like Arda's Uncrafting Table, one of my more well-known mods, or a simple horror-themed mod and even a language resource pack — while others are bigger, more ambitious systems: golems, ore expansions, mining hammers, backpacks, and special ability mods. I like moving between scales like this; not every project needs to be huge to be worth building.`,
            tr: `En popüler ve en sevilen projem <strong><a href="https://modrinth.com/mod/ardas-sculks" target="_blank" rel="noopener">Arda's Sculks</a></strong> — yeni bloklar, mekanikler ve tam bir boss savaşı ekleyen, hem 1.21.1 hem 1.20.1 sürümlerinde oynanabilen bir Deep Dark genişletmesi. Onu ve diğer tüm çalışmalarımı Projeler sekmesinde bulabilirsin; her mod doğrudan kendi Modrinth veya CurseForge sayfasına bağlanır.<br><br>Toplamda Forge ve NeoForge için 12 proje yayınladım. Bazıları küçük ve odaklı yapımlar — Arda's Uncrafting Table gibi daha tanınmış modlarımdan biri, basit bir korku temalı mod, hatta bir dil paketi — bazıları ise daha büyük ve iddialı sistemler: golemler, cevher genişletmeleri, madencilik çekiçleri, sırt çantaları ve özel yetenek modları. Bu şekilde farklı ölçekler arasında gidip gelmeyi seviyorum; her projenin değerli olmak için dev boyutta olması gerekmiyor.`
        },
        about_p2: {
